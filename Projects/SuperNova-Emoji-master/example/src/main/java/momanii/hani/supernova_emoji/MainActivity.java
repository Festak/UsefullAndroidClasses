    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String test = org.apache.commons.lang3.StringEscapeUtils.escapeJava(newText);
                Log.v("MyTag", test);
                String newText1 = org.apache.commons.lang3.StringEscapeUtils.unescapeJava(test);
                textView.setText(newText1);
                Log.v("MyTag", newText1);
            }
        });
    }
